...
<head>
  ...
  <title>Wellness - Consults Per Employee</title>
...
ajR4.open("GET", "consperempajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
  ...
  <?php
  	if (isset($_POST['sub1'])){
		...
		$res1 = $obj1->getempconsnumbers($clid, $locid, $sex, $arl, $arh, $year, $month);
		//$res1 = $obj1->getempconscountarr($clid, $locid, $sex, $arl, $arh, $year, $month);
		var_dump($res);
		//print $res;
		//Get caption
		$cap = $obj1->getcaption($clid, $locid, $sex, $arl, $arh, $year, $month);
		$leg = array("Zero Consults", "One Consult", "Two Consults", "Three Consults", "Four Consults", "Five Consults", "More Than Five Consults");
		$rca = $obj1->randcolorarr($leg);
		//var_dump($rca);
		$y = "";
		...
		$maxarr = array($hccmax, $iccmax, $occmax, $pccmax);
		
		$max = max($maxarr);
		
		$res[0] = array($res1[0][0], $res1[1][0], $res1[2][0], $res1[3][0]);
		$res[1] = array($res1[0][1], $res1[1][1], $res1[2][1], $res1[3][1]);
		$res[2] = array($res1[0][2], $res1[1][2], $res1[2][2], $res1[3][2]);
		$res[3] = array($res1[0][3], $res1[1][3], $res1[2][3], $res1[3][3]);
		$res[4] = array($res1[0][4], $res1[1][4], $res1[2][4], $res1[3][4]);
		$res[5] = array($res1[0][5], $res1[1][5], $res1[2][5], $res1[3][5]);
		$res[6] = array($res1[0][6], $res1[1][6], $res1[2][6], $res1[3][6]);
...
<body><?php include('header.php'); ?> 
	...
	<div class="row">
		<div class="twelve columns">
			...
			<form name="repfrm1" id="frmrep1" method="post" action="consperemp.php">
				<div class="row">
					<div class="three columns">
				...
				<div class="row">
					...
					<div class="ten columns">
						...
						<?php
							...
							if ($res != ""){
								print "<h5>"."Consults Per Employee :  ".$y."</h5>"."<br />";
							}
						?>
						<br />
						<br />
