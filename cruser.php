...
<head>
  ...
  <title>Wellness - Create New User</title>
  ...
  <?php
	...
	if (isset($_POST['sub1'])){
		...
		if ($e == 0){
			...
			$res = $obj1->upcreatelog($suname, $ipadd, $dts, $euname);
		...
		<div class="twelve columns" id="container1a">
			...
			<div class="row" id="content3">
				<div class="twelve columns" id="content3a">
					<form name="adminonefrm" id="frmadminone" action="cruser.php" method="post" enctype="multipart/form-data">
						<fieldset>
						...
						<fieldset>
							...
							<div class="row" id="adminobj18">
								<div class="three columns" id="adminobj18a">
									<label class="adminlkey">Privilege</label>
								</div>
								<div class="four columns" id="adminobj18b">
									<select name="priv" id="sel2" tabindex="13">
										<option value="0" selected="selected">Select Privilege</option>
										<option value="admin">Admin</option>
										<option value="guide">Guide</option>
									</select>
								</div>
								<div class="five columns" id="loginobj18c">
									<label class="adminlval"><?php print $privsta; ?></label>
								</div>
							</div>
						</fieldset>
						<fieldset>
							...
							<div class="row" id="adminobj13">
								...
								<div class="four columns" id="adminobj13b">
									<input type="text" name="uname" id="txt13" tabindex="14" maxlength="20" placeholder="Username" value="<?php print $uname; ?>"/>
								</div>
							...
							<div class="row" id="adminobj14">
								...
								<div class="four columns" id="adminobj14b">
									<input type="password" name="pass" id="txt14" tabindex="15" maxlength="20" placeholder="Password" />
								</div>
							...
							<div class="row" id="adminobj15">
								...
								<div class="four columns" id="adminobj15b">
									<input type="password" name="passx" id="txt15" tabindex="16" maxlength="20" placeholder="Retype Password" />
								</div>
