...
<head>
  ...
  <title>Wellness - Delete Sub Topic</title>
...
ajR4.open("GET", "delsubtopicajax.php?constypeid=" + ghi, true);
ajR4.send(null);
};
  </script>
...
ajR3.open("GET", "delsubtopicajax1.php?constypeid=" + abc + "&topicid=" + def, true);
ajR3.send(null);
};
  </script>
  
  <?php
  	$obj1 = new delsubtopic;
	...
	if (isset($_POST['sub1'])){
		...
		//All is well
		if ($e == 0){
			$res1 = $obj1->delsubtopic1($subtopicid);
			if ($res1){
				...
				if ($res2){
					$outsta = "Sub Topic deleted successfully";
				}
				else{
				...
				$outsta = "Error deleting Sub Topic";
			}
		}
		...
		<div class="twelve columns" id="container1a">
			...
			<div class="row">
				<div class="twelve columns">
					<form name="frmtopic" id="topicfrom" action="delsubtopic.php" method="post">
						<fieldset>
							<legend>Delete Sub Topic</legend>
							<div class="row">
							...
							<div class="row">
								...
								<div class="four columns">
									<input type="submit" name="sub1" id="but1" tabindex="4" value="Delete" class="success button"/>
								</div>
								<div class="five columns">
									<?php print $outsta; ?>
								</div>
