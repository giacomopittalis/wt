...
<head>
  ...
  <title>Wellness - Lock User</title>
	...
	if (isset($_POST['sub1'])){
		...
		if ($outsta == ""){
			...
			if ($res1){
				...
				$res2 = $obj1->uplocklog($suname, $ipadd, $dts, $euname);
				
				if ($res2){
					$outsta = "User Successfully locked";
				}
				else{
					$outsta = "User could not be locked";
				}
			}
		}
	}
		...
		<div class="twelve columns" id="container1a">
			...
			<div class="row" id="contentunlk5">
				<div class="four columns centered" id="contentunlk5a">
					<form name="frmunlock" id="unlockfrom" action="lock.php" method="post">
						<fieldset>
							<legend>Lock User</legend>
							<div class="row" id="unlk1">
								<div class=" twelve columns" id="unlk1a">
									<?php
										$obj1->printactivelist();
									?>
									<br />
									<br />
								</div>
							...
							<div class="row" id="unlk2">
								<div class=" twelve columns" id="unlk2a">
									<input type="submit" name="sub1" id="but1" tabindex="2" class="success button" value="Lock" />
								</div>
							</div>
