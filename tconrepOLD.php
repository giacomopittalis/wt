...
<head>
  ...
  <title>Wellness - Total Number Of Consults</title>
...
ajR4.open("GET", "tconrepajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
  ...
  <?php
  	if (isset($_POST['sub1'])){
		...
		$res = $obj1->getconscount($clid, $locid, $sex, $arl, $arh, $year, $month);
		//var_dump($res);
		//print $res;
		//Get caption
		$cap = $obj1->getcaption($clid, $locid, $sex, $arl, $arh, $year, $month);
		$leg = array("Health Consult", "Injury Consult", "Opportunity Consult", "Proactive Consult");
		$rca = array("ff3344", "11ff11", "22aacc", "3333aa");
		...
		<div class="twelve columns">
			...
			<div class="row">
				...
				<div class="four columns">
					<h4>Total Number Of Consults</h4>
					<br />
				</div>
				<div class="three columns">
			...
			<form name="repfrm1" id="frmrep1" method="post" action="tconrep.php">
				<div class="row">
					<div class="three columns">
				...
				<div class="row">
					...
					<div class="ten columns">
						...
						<?php
							...
							if ($res != ""){
								print "<h5>"."Consults :  ".$y."</h5>"."<br />";
							}
							if ($res != ""){
								print "<h5>"."Total :  ".$tot."</h5>"."<br />";
							}
						?>
						<br />
						<br />
