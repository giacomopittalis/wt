...
<head>
  ...
  <title>Wellness - Average Contacts Per Employee</title>
...
ajR4.open("GET", "conavgempajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
  ...
  <?php
  	if (isset($_POST['sub1'])){
		...
		$res = $obj1->getempavgcon($clid, $locid, $sex, $arl, $arh, $year, $month);
		//var_dump($res);
		//print $res;
		//Get caption
		$cap = $obj1->getcaption($clid, $locid, $sex, $arl, $arh, $year, $month);
		$leg = array("Average Contacts Per Employee");
		$rca = array("ff3344");
		...
		<div class="twelve columns">
			...
			<div class="row">
				...
				<div class="four columns">
					<h4>Average Contacts Per Employee</h4>
					<br />
				</div>
				<div class="three columns">
			...
			<form name="repfrm1" id="frmrep1" method="post" action="conavgemp.php">
				<div class="row">
					<div class="three columns">
				...
				<div class="row">
					...
					<div class="ten columns">
						...
						<?php
							...
							if ($res != ""){
								print "<h5>"."Average Contacts Per Employee :  ".$y."</h5>"."<br />";
							}
						?>
						<br />
						<br />
