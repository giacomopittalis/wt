...
<head>
  ...
  <title>Wellness - Location Comparative Contact Report</title>
...
ajR4.open("GET", "mlconrepajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
  ...
  <?php
  	if (isset($_POST['sub1'])){
		...
		if ($e == 0){
			$res = $obj1->getmlconrep($clid, $locid, $sex, $arl, $arh, $year, $month);
			$cap = $obj1->getcaption($clid, $locid, $sex, $arl, $arh, $year, $month);
			$leg = $obj1->getlegarr($locid);
			$rca = $obj1->randcolorarr($locid);
		...
		<div class="twelve columns">
			...
			<div class="row">
				...
				<div class="four columns">
					<h4>Location Comparative Contact Report</h4>
					<br />
				</div>
				<div class="three columns">
