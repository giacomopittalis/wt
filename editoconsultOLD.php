...
<head>
  ...
  <title>Wellness - Edit Opportunity Consult</title>
...
ajR4.open("GET", "editoconsultajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
...
ajR3.open("GET", "editoconsultajax1.php?clid=" + abc + "&locid=" + def, true);
ajR3.send(null);
};
  </script>
  
  <?php $obj1 = new editoconsult; ?>
  ...
  <?php
	...
	if (isset($_POST['sub1'])){
		...
		if ($e == 0){
			$res = $obj1->editoc($input);
			if ($res){
				$outsta = "Opportunity consult successfully edited";
			}
			else{
				$outsta = "Opportunity consult could not be edited";
			}
		}
...
<body><?php include('header.php'); ?> 
	...
	<div class="row">
		<div class="twelve columns">
			<form name="iconsultfrm" id="frmiconsult" action="editoconsult.php" method="post">
				<fieldset>
					<div class="row">
						<div class="three columns">
							<label>Client</label>
				...
				<fieldset>
					<div class="row">
						<div class="three columns">
							<label>Opportunity Consult</label>
						</div>
						<div class="four columns" id="consultajax2">
							<?php $obj1->printinitoclist(); ?>
						</div>
						<div class="five columns">
							<label><?php print $ocidsta ?></label>
						</div>
					</div>
				</fieldset>
				<fieldset>
					<div class="row">
						...
						<div class="three columns">
							<textarea name="comm" id="comm" tabindex="1" rows="10" cols="30"></textarea>
						</div>
						<div class="five columns">
