...
<head>
  ...
  <title>Wellness - Unlock User</title>
	...
	if (isset($_POST['sub1'])){
		...
		if ($outsta == ""){
			...
			if ($res1){
				...
				$res2 = $obj1->upunlocklog($suname, $ipadd, $dts, $euname);
				
				if ($res2){
					$outsta = "User Successfully Unlocked";
				}
				else{
					$outsta = "User could not be unlocked";
				}
			}
		}
	}
		...
		<div class="twelve columns" id="container1a">
			...
			<div class="row" id="contentunlk5">
				<div class="four columns centered" id="contentunlk5a">
					<form name="frmunlock" id="unlockfrom" action="unlock.php" method="post">
						<fieldset>
							<legend>Unlock User</legend>
							<div class="row" id="unlk1">
								<div class=" twelve columns" id="unlk1a">
									<?php
										$obj1->printlockedlist();
									?>
									<br />
									<br />
								</div>
							...
							<div class="row" id="unlk2">
								<div class=" twelve columns" id="unlk2a">
									<input type="submit" name="sub1" id="but1" tabindex="2" class="success button" value="Unlock" />
								</div>
							</div>
