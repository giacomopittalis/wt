  ...
  <?php
	...
	if (isset($_POST['sub1'])){
		...
		if (!$dex){
			$res = $obj->insano();
			if ($res){
				$outsta = "Anoplate data successfully inserted";
			}
			else{
				$outsta = "Could not insert Anoplate data";
			}
		}
		else{
			$outsta = "Anoplate data already exists";
		}
		...
		<div class="twelve columns" id="container1a">
			...
			<div class="row" id="contentunlk5">
				<div class="four columns centered" id="contentunlk5a">
					<form name="frmunlock" id="unlockfrom" action="anoplate.php" method="post">
						<fieldset>
							<legend>Anoplate</legend>
