...
<head>
  ...
  <title>Wellness - Edit Well Credit Consult</title>
...
ajR4.open("GET", "editwconsultajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
...
ajR3.open("GET", "editwconsultajax1.php?clid=" + abc + "&locid=" + def, true);
ajR3.send(null);
};
  </script>
  
  <?php $obj1 = new editwconsult; ?>
