...
<head>
  ...
  <title>Wellness - Contacts Per Employee</title>
...
ajR4.open("GET", "conperempajax.php?clid=" + ghi, true);
ajR4.send(null);
};
  </script>
  ...
  <?php
  	if (isset($_POST['sub1'])){
		...
		$res = $obj1->getempconnumbers($clid, $locid, $sex, $arl, $arh, $year, $month);
		//var_dump($res);
		//print $res;
		//Get caption
		$cap = $obj1->getcaption($clid, $locid, $sex, $arl, $arh, $year, $month);
		$leg = array("Zero Contacts", "One Contact", "Two Contacts", "Three Contacts", "Four Contacts", "Five Contacts", "More Than Five Contacts");
		$rca = $obj1->randcolorarr($res);
				...
				<div class="row">
					...
					<div class="ten columns">
						...
						<?php
							...
							if ($res != ""){
								print "<h5>"."Contacts Per Employee :  ".$y."</h5>"."<br />";
							}
						?>
						<br />
						<br />
